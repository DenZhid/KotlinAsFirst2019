...
fun timeForHalfWay(
    ...
    return when {
        sHalf / v1 <= t1 -> sHalf / v1
        (sHalf - v1 * t1) / v2 <= t2 -> (sHalf - v1 * t1) / v2 + t1
        (sHalf - v1 * t1 - v2 * t2) / v3 < t3 -> (sHalf - v1 * t1 - v2 * t2) / v3 + t1 + t2
        else -> Double.NaN
    }
}
...
fun segmentLength(a: Int, b: Int, c: Int, d: Int): Int = when {
    ((a == c) && (b == a)) || ((a > c) && (d > a) && (d > b)) -> b - a
    (a < c) && (b < c) || (a > c) && (d < a) -> -1
    ((a < c) && (b == c)) || ((a > c) && (a == d)) || ((a == b) && (a == c)) || ((a == c) && (a == d)) || ((b == c) && (b == d)) -> 0
    (a < c) && (b > c) && (b < d) -> b - c
    (a > c) && (d > a) && (d < b) -> d - a
    (a < c) && (b > c) && (b > d) -> d - c
    else -> -2
