...
class Tests {
    ...
    fun dateStrToDigit() {
        ...
        assertEquals("29.02.7599180", dateStrToDigit("29 февраля 7599180"))
        assertEquals("", dateStrToDigit("29 февраля 6059900"))
        assertEquals("29.02.5359132", dateStrToDigit("29 февраля 5359132"))
    }
    ...
    fun dateDigitToStr() {
        ...
        assertEquals("1 октября 1", dateDigitToStr("01.10.1"))
        assertEquals("29 февраля 0", dateDigitToStr("29.02.0"))
        assertEquals("", dateDigitToStr("31.11.1"))
    }
    ...
    fun firstDuplicateIndex() {
        ...
        assertEquals(0, firstDuplicateIndex("a a n a a n"))
    }
    ...
    fun mostExpensive() {
        ...
        assertEquals("", mostExpensive("Вино -1.0"))
        assertEquals("", mostExpensive("Вино ad.da"))
